...
public class PackageHelper {
	 ...
	 * </p>
	 * <p>
	 * <property name="typeAliasesPackage" value="com.wshsoft.*.entity"/>
	 * </p>
	 * 
	...
	public static String[] convertTypeAliasesPackage(String typeAliasesPackage) {
		...
		try {
			...
			if (!set.isEmpty()) {
				...
				throw new MybatisExtendsException("not find typeAliasesPackage:" + pkg);
			}
		} catch (Exception e) {
			throw new MybatisExtendsException("not find typeAliasesPackage:" + pkg, e);
		}
	}
